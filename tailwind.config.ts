    ...
    extend: {
      ...
      keyframes: {
        ...
        "love-beat-glow": {
          ...
          "25%": { boxShadow: "0 0 40px hsl(var(--romantic-heart-soft) / 0.9)" },
          "50%": { boxShadow: "0 0 10px hsl(var(--romantic-heart-soft) / 0.5)" },
          "75%": { boxShadow: "0 0 32px hsl(var(--romantic-heart-soft) / 0.85)" },
      ...
      animation: {
        ...
        "love-beat-heart": "love-beat-heart 0.95s ease-in-out infinite",
        "love-beat-glow": "love-beat-glow 1.1s ease-in-out infinite",
      },
    },
  },
