...
// نوزّع الكرز على طول المرحلة بطريقة مرتبة فوق الأرض والمنصات
const CHERRIES = [
  // قرب البداية – فوق الأرض وعلى أول منصة منخفضة
  { id: 1, x: 160, y: 210 },
  { id: 2, x: 260, y: 190 },
  { id: 3, x: 360, y: 210 },

  // مجموعة على منصات متوسطة الارتفاع
  { id: 4, x: 520, y: 185 },
  { id: 5, x: 620, y: 165 },
  { id: 6, x: 720, y: 185 },

  // منتصف المرحلة – مسار علوي
  { id: 7, x: 920, y: 170 },
  { id: 8, x: 1040, y: 150 },
  { id: 9, x: 1160, y: 170 },
...
// منصات موزّعة بشكل متدرج على طول العالم
const PLATFORMS = [
  // منصات قريبة من الأرض في البداية
  { x: 240, y: 200, width: 120, height: 10 },
  { x: 520, y: 190, width: 130, height: 10 },

  // منتصف المرحلة – منصات أعلى قليلًا
  { x: 900, y: 180, width: 140, height: 10 },
  { x: 1120, y: 165, width: 140, height: 10 },

  // قرب النهاية – منصات متدرجة للأعلى ثم للأسفل
  { x: 1380, y: 190, width: 130, height: 10 },
  { x: 1620, y: 180, width: 130, height: 10 },
  { x: 1860, y: 195, width: 140, height: 10 },
] as const;
